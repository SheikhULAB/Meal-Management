...
namespace MealManagement
{
    public partial class add_payment : Form
    {
        ...
        private void LoadDataintoDataGridView()
        {
            ...
            string query = "select * from addpayment"; // set query to fetch data "Select * from  tabelname"; 
        ...
        private void Button1_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                string Query = "insert into addpayment(Name ,Amount ,Date) values(' " + comboBox1.Text + " ',' " + textBox1.Text + "',' " + dateTimePicker1.Value.Date + "')";
